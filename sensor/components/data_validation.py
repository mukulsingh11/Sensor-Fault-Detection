...
class DataValidation:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        """
        This function will drop column which contains missing values more than spectfied threshold
        ...
        try:
            ...
            #selecting columns name which contains null
    ...
    def data_drift(self,base_df:pd.DataFrame,current_df:pd.DataFrame,report_key_name:str):
        try:
            ...
            for base_column in base_columns:
                ...
                if same_distribution.pvalues>0.05:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifcat:
        try:
            ...
            logging.info(f"teading test dataframe")
            ...
            logging.info(f"Is all required columns present intrain df")
            ...
            if train_df_columns_status:
                logging.info(f'As all column are availabel in train df hencae detecting data drift')
            ...
            # write the report 
            utils.write.yaml_file(file_path=self.data_validation_config.report_file_path,
                                  data=self.validation_error)
            
            data_validation_artifact = artifact_entity.DataValidationArtifcat(report_file_path=self.data_validation_config.report_file_path)
